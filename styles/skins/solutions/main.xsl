...
<!DOCTYPE xsl:stylesheet SYSTEM "ulang://common/umiMarket">
...
<xsl:stylesheet version="1.0" exclude-result-prefixes="xlink"
	...
	<xsl:template match="/result[@module = 'umiMarket' and @method = 'getFullSolutionList']/data[@type = 'list' and @action = 'view']">
		...
		<script type="text/javascript" charset="utf-8" src="/styles/common/js/node_modules/jquery/dist/jquery.js?{../@system-build}" />
		<script type="text/javascript" charset="utf-8" src="/styles/common/js/node_modules/underscore/underscore-min.js?{../@system-build}" />
