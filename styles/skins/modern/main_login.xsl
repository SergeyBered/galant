...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<script type="text/javascript" src="/styles/common/js/jquery/jquery-migrate.js" />
	...
	<xsl:template name="mainRestorePasswordForm">
		<form id="forget" action="/udata/users/forget_do/.json?lang={$interface-lang}" method="post">
			<div class="row">
				<div class="col-md-12">
			...
			<div class="row reset_container">
				<div class="col-md-12">
					<div id="resetFormAnswer"/>
					<div id="successFormAnswer">&js-restore-password-success;</div>
				</div>
			</div>
