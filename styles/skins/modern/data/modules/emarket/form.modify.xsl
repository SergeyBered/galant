...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/result[@method = 'discount_add' or @method = 'discount_modify']/data" priority="1">
		...
		<script>
			$(function (){
				jQuery('input.discount-type-id').on('click', function () {
					...
					jQuery('div.discount-params#' + discountTypeId + ' input').removeAttr('disabled');
			...
			<div>
				...
				<template id="layoutsTpl">
					<![CDATA[
						...
						<a class="asps_tabs_nav prev"></a>
						<a class="asps_tabs_nav next"></a>
