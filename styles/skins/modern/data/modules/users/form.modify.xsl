...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:umi="http://www.umi-cms.ru/TR/umi">
	...
	<xsl:template match="module/option">
		<xsl:if test="@name != 'adminEntryPoints'">
			<li>
				<label>
					<div class="checkbox">
						<xsl:if test="@access > 0">
	...
	<!--Заглушка для поля "Деактивирован менеджером сайта"-->
	<xsl:template match="field[@name = 'is_deactivated_by_manager']" mode="form-modify" />
