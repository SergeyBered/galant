...
jQuery(function(){
	...
	jQuery('#statdate_settings input[type="text"]').on('keypress', function(e) {
		if(e.which == 13) {
			goFilter();
		}
	});

	jQuery('#startEmarketStat').on('click', goFilter);
	...
	jQuery('#statLinks a').on('click', function(e) {
	...
	jQuery('#statTopPopular th').on('click', function(e) {
		var elem = jQuery('#statTopPopular');
	...
	jQuery('#statdate_settings .datePicker input').on('change', function(e) {
		changedDate = true;
	});
});
