	...
	class DispatchesAdmin {
		...
		public function lists() {
			...
			$selector = Service::SelectorFactory()
				->createObjectTypeName('dispatches', 'dispatch');
		...
		public function subscribers() {
			...
			$selector = Service::SelectorFactory()
				->createObjectTypeName('dispatches', 'subscriber');

			if ($dispatchId) {
				$selector->where('subscriber_dispatches')->equals($dispatchId);
			}
		...
		public function releases() {
			...
			$selector = Service::SelectorFactory()
				->createObjectTypeName('dispatches', 'release');

			if ($dispatchId) {
				$selector->where('disp_reference')->equals($dispatchId);
			}
