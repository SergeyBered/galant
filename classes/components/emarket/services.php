<?php
	...
	$rules = [
		...
		'ReceiptSerializerDengiOnline' => [
			'class' => 'UmiCms\Classes\Components\Emarket\Serializer\Receipt\DengiOnline',
			'arguments' => [
				new ServiceReference('Currencies'),
				new ServiceReference('TaxRateVat'),
				new ServiceReference('DomainDetector'),
		...
		'EmarketSettings' => [
			'class' => 'UmiCms\Classes\Components\Emarket\Config\Settings'
		],

		'OrderValidator' => [
			'class' => 'UmiCms\Classes\Components\Emarket\Order\Validator',
			'arguments' => [
				new ServiceReference('EmarketSettings')
			]
		]
	];
