<?php
	...
	interface iCalculateDeliveryCost {
		...
		/** @const string INCLUDE_FEES_KEY ключ данных запроса с включения в цену страхового сбора и сбора за кассовое обслуживание */
		const INCLUDE_FEES_KEY = 'includeFees';
		...
		/**
		 * Устанавливает включать ли в цену страховой сбор и сбор за кассовое обслуживание
		 * @param bool $status статус
		 * @return $this|iCalculateDeliveryCost
		 */
		public function setIncludeFees(bool $status) : iCalculateDeliveryCost;

		/**
		 * Определяет включать ли в цену страховой сбор и сбор за кассовое обслуживание
		 * @return bool
		 */
