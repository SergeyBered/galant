<?php
	...
	class filemanager extends def_module {
		...
		public function includeCommonClasses() {
			...
			$this->__loadLib('Classes/elfinder/fileManager.php');
			$this->__implement('UmiCms\Classes\Components\Filemanager\Filemanager');

			$this->__loadLib('handlers.php');
			$this->__implement('FilemanagerHandlers');
