<?php
	...
	$i18n = [
		...
		'error-macros-empty-return' => 'Macros returned an empty response',
		...
		'error-non-unique-field-name-in-parent-type' => 'Field with this name already exists in parent type - %s',
		'error-non-unique-field-name-in-child-type' => 'Field with this name already exists in child type - %s',
		...
		'error-require-default-template' => 'Default template is required. Please setup this template in module <a href="/admin/umiTemplates" target="_blank">"Site templates"</a>.',
		...
		'js-error-password-login-match' => 'Same login and password',
		...
		'save' => 'Save',
		'group-config' => 'Common settings',
		'option-per_page' => 'Elements per page',
		...
		'group-google-oauth' => 'Google Authorisation (OAuth) settings',
		'option-google-service-account' => 'Service account',
		'option-google-private-key' => 'Private key',
		'option-google-hint-label' => 'You need to register with Google Console, more information in the help',
		'label-delete-google-private-key' => 'Delete private key',
		'label-error-google-private-key-save' => 'Cannot save private key',
		'label-error-google-private-key-delete' => 'Cannot delete private key',
		...
		'label-module' => 'module',
		'label-method' => 'method',
		'label-base-type-hide-pages' => 'Hide pages',
		'label-file' => 'file',
		'label-folder' => 'folder',
		...
		'label-has-been-deleted-m' => 'has been deleted',
		'label-has-been-deleted-f' => 'has been deleted',
		'label-has-been-deleted-n' => 'has been deleted',
		'label-has-been-copied-m' => 'has been copied',
		'label-entity-optioned-field-set-value' => 'Entity %s (%d) have been set optioned field\'s "%s" value: %s',
		...
		'js-file-field-remove-file' => 'Remove file',
		...
		'label-MigrateFileFields' => 'File fields migration',
		...
		'label-MoveFileValues' => 'Move file fields values',
		'label-MigrateLangIdFields' => 'Migration of fields with lang id to "Link to lang" type',
		'label-MoveLangIdValue' => 'Move of fields values "Link to lang" type',
		...
		'label-opcache-enable-alert' => 'You have php extension "Zend OPcache" enabled, this may lead to update errors. We recommend disabling the extension during updates.',
		...
		'js-symlink-only-one-warning' => 'Only one site section can be selected in this field, the field value will be overwritten.',
		'js-update-available' => 'Update available',
		'js-update-available-text' => 'See what has changed in the <a href="https://www.umi-cms.ru/product/changelog/#change_%s">new version</a>',
		'js-update-system' => 'Update system',
		'label-no-template' => 'Without template',
		'js-error-add-empty-option-header' => 'Error adding option',
		'js-error-add-empty-option-text' => 'You need to select a guide item and specify the value of the option',
		'js-error-add-same-relation-option-text' => 'An option has already been created for the selected guide item',
		'js-error-add-same-value-option-text' => 'An option has already been created with the specified value',
		'label-errors-cannot-get-field-type' => 'Cannot get %s field type "%s"',
		'label-errors-cannot-create-field' => 'Cannot create field "%s" (%s) with type %s',
		'label-errors-incorrect-guide-id-given' => 'Incorrect guide id given: %s',
		'label-update_permissions_filemanager' => 'Updating file system permissions',
		'label-UpdatePermissionsFilemanager' => 'Transfer user permissions to manage the file system',
		'label-add-page' => 'Add page',
		'js-del-object-title-short' => 'Deletion confirmation',
		'js-del-page-warning' => "You are going to delete page. If you shure, press 'Delete'.<br />After deleting page will appear in trash bin. Supervisor will be able restore it.",
		'js-del-object-warning' => 'Are you sure you want to remove an object? It will be permanently deleted.',
		...
		'js-editable-multiple_image-field' => 'Edit multiple image',
		'js-editable-multiple_file-field' => 'Edit multiple file',
		'js-editable-text-field' => 'Edit simple text',
		'js-editable-wysiwyg-field' => 'Edit HTML-text',
		'js-editable-symlink-field' => 'Edit link to page',
		'label-login-store' => 'Remember me',
		'js-label-login-store' => 'Remember me',
		'error-сsrf-protection-check-failed' => 'CSRF token expired, reload page',
		'label-file-size-format-b' => '%.2f Byte',
		'label-file-size-format-k' => '%.2f Kilobyte',
		'label-file-size-format-m' => '%.2f Megabyte',
		'label-file-size-format-g' => '%.2f Gigabyte',
		'label-file-size-format-t' => '%.2f Terabyte',
		'label-file-size-format-p' => '%.2f Petabyte',
		'js-label-error-page-no-active' => 'Page is not active',
		'label-file-size' => 'Size',
		'js-label-template-confirm-delete' => 'Deleting confirmation',
		'label-error-bad-private-key' => 'Incorrect private key given',
		'label-no-module-permissions' => 'You are on the page of the adminzone, which you do not have rights to view.<br>You can contact the site administrator to get the permissions, <a href="%s">go to the first available module</a> or select it in the modules menu.'
	];
