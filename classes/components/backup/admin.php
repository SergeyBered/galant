	...
	class BackupAdmin {
		...
		public function config() {
			...
			if ($this->isSaveMode() && !isDemoMode()) {
				...
				$umiRegistry->set('//modules/backup/enabled', $params['backup']['boolean:backup-enabled']);
			...
			$params['backup']['boolean:backup-enabled'] = $umiRegistry->get('//modules/backup/enabled');
