		...
		public function config() {
			...
			$params = [
				'config' => [
					...
					'boolean:allow_guest_messaging' => null,
			...
			if ($this->isSaveMode()) {
				...
				$regedit->set('//modules/forum/allow_guest', $params['config']['boolean:allow_guest_messaging']);
			...
			$params['config']['boolean:allow_guest_messaging'] = (int) $regedit->get('//modules/forum/allow_guest');
