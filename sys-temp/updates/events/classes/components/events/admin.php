	...
	class EventsAdmin {
		...
		public function last() {
			...
			foreach ($settings as $typeId) {
				...
				$module = explode('-',$typeId)[0];				
				$module = cmsController::getInstance()->getModule($module);
				$img = $module->getIconPath();
				$newEvents['nodes:new-event'][$typeId]['attribute:img'] = $img;
