	...
	class WebformsAdmin {
		...
		public function addresses() {
			...
			$selector = Service::SelectorFactory()
				->createObjectTypeName('webforms', 'address');
		...
		public function templates() {
			...
			$selector = Service::SelectorFactory()
				->createObjectTypeName('webforms', 'template');
			$selector->limit($offset, $limit);
			selectorHelper::detectWhereConditionByRequest($selector, 'id', 'rel');
			selectorHelper::detectFilters($selector);
		...
		public function messages() {
			...
			if (is_numeric($types) || is_array($types)) {
				$selector->types('object-type')->id($types);
			} else {
				$selector->types('object-type')->name('webforms', 'form');
			}
