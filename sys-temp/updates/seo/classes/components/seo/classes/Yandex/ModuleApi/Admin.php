<?php
	...
	class Admin implements \iModulePart {
		...
		public function getSiteInfo($siteId = null) {
			...
			$siteId = $this->getPreparedSiteId($siteId);
...
HTML;
		...
		/**
		 * Возвращает id сайта в подготовленном для запросов виде
		 * @param string $siteId id сайта
		 * @return string
		 */
		private function getPreparedSiteId(string $siteId) : string {
			return str_replace('/', '', $siteId);
		}
