<?php
	...
	interface iClient {
		...
		/**
		 * Возвращает историю изменения ИКС
		 * @link https://yandex.ru/dev/webmaster/doc/dg/reference/sqi-history-docpage/#sqi-history
		 * @param string $siteId идентификатор сайта
		 * @param int|null $from начало диапазона дат
		 * @param int|null $to конец диапазона дат
		 * @return array
