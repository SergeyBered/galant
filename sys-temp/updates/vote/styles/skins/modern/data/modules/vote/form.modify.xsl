	...
	<xsl:template name="answers_list_form">
		...
		<script type="text/javascript">
			...
			<![CDATA[
				...
				$('#answers_list').find('input.checkbox').on('click', function (e) {
					var $input = $(e.target);
			...
			function saveAnswersList() {
				...
				$('#answers_list').html('<table border=\"0\" width=\"100%\" ><tbody><tr><td style=\"text-align:center;\" ><br /><img src=\"/styles/skins/modern/design/img/loading_bar.gif\" /><br />]]>&label-wait;<![CDATA[</td></tr></tbody></table>');
