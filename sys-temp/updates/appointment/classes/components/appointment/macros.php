<?php
	...
	class AppointmentMacros {
		...
		public function postAppointment() {
			$useCaptcha = (bool) Service::Registry()->get('//modules/appointment/use-captcha');

			if ($useCaptcha && !umiCaptcha::checkCaptcha()) {
				$this->printError(getLabel('error-incorrect-captcha', 'appointment'));
			}
		...
		public function employeesList($template = 'default', $limit = 25, $selectedId = null) {
			...
			$params[$collectionMap->get('OFFSET_KEY')] = Service::Request()->pageNumber() * $limit;
