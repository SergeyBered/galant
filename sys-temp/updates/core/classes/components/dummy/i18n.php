<?php
	...
	$i18n = [
		...
		'perms-dummy-guest' => 'Права на просмотр данных на сайте',
		'perms-dummy-admin' => 'Права на администрирование',
		'perms-dummy-config' => 'Права на работу с настройками',
		'perms-dummy-delete' => 'Права на удаление объектов и страниц',
	];
