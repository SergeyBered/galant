...
<xsl:output method="html" encoding="utf-8" indent="yes" doctype-public="-//W3C//DTD XHTML 1.0 Strict//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd" />
	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" lang="ru">
			<head>
				...
				<script type="text/javascript" src="/styles/common/js/jquery/jquery-migrate.js" charset="utf-8"></script>
				<style>
					body {
						margin: 0;
	...
	<xsl:template match="purchasing[@stage = 'delivery'][@step = 'address']">
		...
		<script>
			jQuery('#delivery_address').on('submit', function(){
		...
		<form id="payment_choose" method="post" action="do/">
			<script>
				<![CDATA[
					...
					jQuery('#payment_choose').on('submit', function(){
						if (window.paymentId) {
	...
	<xsl:template match="result[@module = 'blogs20'][@method = 'post']">
		...
		<div id="blog_items">
			<div class="blog_item">
				...
				<div class="social">
					<script type="text/javascript">
						jQuery(function(){ jQuery.getScript('//yandex.st/share/share.js', function() {
					new Ya.share({
						'element': 'ya_share1',
						'elementStyle': {
							'type': 'button',
