...
(function($, undefined) {
    ...
    function newTmplItem(options, parentItem, fn, data) {
        ...
        if(fn) {
            ...
            newItem.tmpl = fn;
            newItem._ctnt = newItem._ctnt || (typeof newItem.tmpl === "function") && newItem.tmpl($, newItem) || fn;
            newItem.key = ++itemKey;
    ...
    function updateWrapped(options, wrapped) {
        ...
        options._wrap = build(options, true,
                ...
                Array.isArray(wrapped) ? wrapped : [regex.html_expr.test(wrapped) ? wrapped : $(wrapped).html()]
        ).join("");
    }
    ...
    function tiHtml(filter, textOnly) {
        ...
        return $.map(
                $(Array.isArray(wrapped) ? wrapped.join("") : wrapped).filter(filter || "*"),
                function(e) {
                    return textOnly ?
