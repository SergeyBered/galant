<?php
	...
	interface iParameter {
		...
		/** @const string DENGI_ONLINE_ID_FIELD имя поля с идентификатором для Деньги Online */
		const DENGI_ONLINE_ID_FIELD = 'dengionline_id';
		...
		/**
		 * Возвращает идентификатор ставки внешнего сервиса "Деньги Online"
		 * @return string
		 */
