	...
	class EmarketAdmin {
		...
		public function currency() {
			...
			$selector = Service::SelectorFactory()
				->createObjectTypeName('emarket', 'currency');
		...
		public function delivery() {
			...
			$selector = Service::SelectorFactory()
				->createObjectTypeName('emarket', 'delivery');
			$selector->limit($offset, $limit);
			selectorHelper::detectWhereConditionByRequest($selector, 'id', 'rel');
			selectorHelper::detectFilters($selector);
		...
		public function discounts() {
			...
			$selector = Service::SelectorFactory()
				->createObjectTypeName('emarket', 'discount');
			$selector->limit($offset, $limit);
			selectorHelper::detectWhereConditionByRequest($selector, 'id', 'rel');
			selectorHelper::detectFilters($selector);
		...
		public function orders() {
			...
			$selector = Service::SelectorFactory()
				->createObjectTypeName('emarket', 'order');
			$selector->where('number')->isnotnull();
			$selector->where('name')->notequals(order::DUMMY_NAME);
			$selector->limit($offset, $limit);

			if (!getRequest('order_filter')) {
				$selector->order('order_date')->desc();
			}
			...
			if (is_array($domains) && umiCount($domains)) {
				...
				if (umiCount($domainsCollection->getList()) > 1) {
					$selector->where('domain_id')->equals($domains[0]);
				}
			}
		...
		public function payment() {
			...
			$selector = Service::SelectorFactory()
				->createObjectTypeName('emarket', 'payment');
			$selector->limit($offset, $limit);
			selectorHelper::detectWhereConditionByRequest($selector, 'id', 'rel');
			selectorHelper::detectFilters($selector);
		...
		public function stores() {
			...
			$selector = Service::SelectorFactory()
				->createObjectTypeName('emarket', 'store');
			$selector->limit($offset, $limit);
			selectorHelper::detectWhereConditionByRequest($selector, 'id', 'rel');
			selectorHelper::detectFilters($selector);
