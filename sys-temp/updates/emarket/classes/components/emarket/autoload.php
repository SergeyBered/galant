<?php
	...
	$classes = [
		...
		'UmiCms\Classes\Components\Emarket\Orders\Calculator' => [
			__DIR__ . '/classes/orders/Calculator.php'
		],
		...
		'UmiCms\Classes\Components\Emarket\Serializer\Receipt\DengiOnline' => [
			__DIR__ . '/classes/Serializer/Receipt/DengiOnline.php'
		],
		...
		'UmiCms\Classes\Components\Emarket\Config\Tab' => [
			__DIR__ . '/classes/Config/Tab.php'
		],

		'EmarketDeliverySettingsAdmin' => [
			__DIR__ . '/classes/Deprecated/EmarketDeliverySettingsAdmin.php'
		],

		'EmarketPaymentSettingsAdmin' => [
			__DIR__ . '/classes/Deprecated/EmarketPaymentSettingsAdmin.php'
		],

		'EmarketSettings' => [
			__DIR__ . '/classes/Deprecated/EmarketSettings.php'
		],

		'UmiCms\Classes\Components\Emarket\Order\iValidator' => [
			__DIR__ . '/classes/orders/iValidator.php'
		],

		'UmiCms\Classes\Components\Emarket\Order\Validator' => [
			__DIR__ . '/classes/orders/Validator.php'
		],
	];
