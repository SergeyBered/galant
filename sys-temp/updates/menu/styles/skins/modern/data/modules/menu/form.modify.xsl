				...
				<div class="contentPages">
					<div class="contentPagesWrap">
						...
						<ul class="menu_pages_list">
							<li class="ti">
								<div class="ti">
									<img style="border: 0px none;" alt="&label-menu-page-content;" title="&label-menu-page-content;" src="/styles/skins/modern/design/img/tree/ico_content_.png" class="ti-icon" />
							...
							<li class="ti">
								<div class="ti">
									<img style="border: 0px none;" alt="&label-menu-page-auth;" title="&label-menu-page-auth;" src="/styles/skins/modern/design/img/tree/ico_content_.png" class="ti-icon" />
							...
							<li class="ti">
								<div class="ti">
									<img style="border: 0px none;" alt="&label-menu-page-personal;" title="&label-menu-page-personal;" src="/styles/skins/modern/design/img/tree/ico_content_.png" class="ti-icon" />
							...
							<li class="ti">
								<div class="ti">
									<img style="border: 0px none;" alt="&label-menu-page-restore;" title="&label-menu-page-restore;" src="/styles/skins/modern/design/img/tree/ico_content_.png" class="ti-icon" />
