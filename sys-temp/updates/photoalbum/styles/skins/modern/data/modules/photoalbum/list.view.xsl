		...
		<div class="tabs-content module">
			<div class="section selected">
				...
				<xsl:choose>
					...
					function photoalbumShowForm(parentId) {
						openDialog('', getLabel('js-upload-from-archive'),
							{html : "<form id='zipform' action='/admin/photoalbum/upload_arhive/' method='post' enctype='multipart/form-data' >\
									...
									<input type='file' accept='application/zip' id='upload' name='zip_arhive' style='width:100%' />\
				...
				<script type="text/javascript">
					$(function() {
						...
						$imagesUploadButton.on('click', function(event) {
