<?php
	...
	$i18n = [
		...
		'header-users-edit-author' => 'Edit author',
		'header-users-add-author' => 'Add author',
		'header-users-authorsList' => 'Authors of publications',
		'label-add-author' => 'Add author',
		...
		'error-not-verified-email' => 'Mail on the service that you are logging in through is not confirmed',
		...
		'perms-users-delete' => 'Permissions for deleting users, groups, and authors',
		...
		'mail-template-users-variable-user_id' => 'User Id',
		'mail-template-users-variable-login' => 'Login',
		'mail-template-users-variable-domain' => 'Domain',
		'mail-template-users-variable-restore_link' => 'Password restore link',
		'mail-template-users-variable-email' => 'Email',
		'mail-template-users-variable-activate_link' => 'Activation link',
		'mail-template-users-variable-password' => 'Password',
		'mail-template-users-variable-fname' => 'First name',
		'mail-template-users-variable-lname' => 'Last name',
		'mail-template-users-variable-father_name' => 'Father name',
	];
